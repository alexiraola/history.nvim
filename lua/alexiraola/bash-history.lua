...
local function update_view(direction)
  ...
  for k,v in pairs(result) do
	  local line = vim.split(result[k], ';', true)
  ...
  api.nvim_buf_set_lines(buf, 3, -1, false, reversed)
...
local function open_term()
	...
	close_window()
	api.nvim_command('edit term://'..str)
end
...
local function set_mappings()
  ...
  for k,v in pairs(mappings) do
    api.nvim_buf_set_keymap(buf, 'n', k, ':lua require("alexiraola").'..v..'<cr>', {
